...
Case of 
	...
	Else 
		...
		$options.title:="catch errors in all execution contexts?"
		
		$options.blog:="https://blog.4d.com/catch-errors-everywhere/"
		$options.info:="Errors management"  //ex : "4D View Pro feature"
